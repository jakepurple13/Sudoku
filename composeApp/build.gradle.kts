...
android {
    namespace = "com.programmersbox.sudoku"
    ...
    defaultConfig {
        applicationId = "com.programmersbox.sudoku"
...
compose.desktop {
    application {
        mainClass = "com.programmersbox.sudoku.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "com.programmersbox.sudoku"
